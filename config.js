...
module.exports = {
    ...
    PACK_NAME: process.env.PACK_NAME || "ΛĿĿᏋЙ",
    ...
    ANTI_CALL_MSG: process.env.ANTI_CALL_MSG || "*📞 ᴄαℓℓ ɴσт αℓℓσωє∂ ιɴ тнιѕ иʋмвɛя cʋɹɹǝuʇlʎ qnsʎ 📵*",
    AUTO_REACT: process.env.AUTO_REACT || "false",
    OWNER_REACT: process.env.OWNER_REACT || "false",
    BOT_NAME: process.env.BOT_NAME || "❥︎☹︎ǤΞŊZƘΞŊΨΔ 254𓆪", // Don't change
